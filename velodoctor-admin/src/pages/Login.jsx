...
export default function Login() {
  ...
  async function handleLogin(e) {
    ...
    if (error) {
      ...
      // La redirection se fera automatiquement par App.jsx
  ...
  return (
    <div style={{
      ...
      backgroundColor: 'var(--dark)', // Fond sombre pour le style
      padding: '20px'
    }}>
      <div style={{
        background: 'white',
        ...
        <p style={{ color: 'var(--gray)', marginBottom: '30px' }}>
          Connectez-vous à l'espace VeloDoctor.
        </p>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
          ...
          {error && (
            <div style={{ color: 'var(--danger)', fontSize: '14px', background: '#fee2e2', padding: '10px', borderRadius: '8px' }}>
              {error}
            </div>
          )}
